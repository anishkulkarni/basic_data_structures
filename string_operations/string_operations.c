...
int main()
{
	...
	char str1[MAX]={'\0'}, str2[MAX]={'\0'}, str3[MAX]={'\0'}, subStr[MAX]={'\0'};
	while (1)
	{
		printMenu();
		choice = getChoice();
		...
		case 9:
			...
			while(getchar()!='\n');
			inputString(subStr);
			lenSubStr = lengthOfString(subStr);
			printf("\nString 1 : ");
			displayString(str1);
			printf("\nString 2 : ");
			displayString(str2);
...
{
	/*
		* Input : Base address string, length of string
...
{
	/*
		* Input : Base addresses of 2 strings, lengths of both strings
...
{
	/*
		* Input : Base addresses of source and target strings
